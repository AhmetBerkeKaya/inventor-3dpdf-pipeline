...
### ⚠️ CRITICAL NOTE: VIEWING 3D PDFs

**Please Read Before Testing:**

The PDFs generated by this pipeline embed **U3D (Universal 3D)** geometry. Most standard PDF viewers (including Google Chrome, Microsoft Edge, and macOS Preview) **DO NOT** support 3D content and will display a blank page or a static placeholder.

To view and interact with the 3D models:
1.  You **MUST** use **[Adobe Acrobat Reader DC](https://get.adobe.com/reader/)** (Free).
2.  When opening the file, a yellow bar will appear at the top asking for permission. Click **"Options" -> "Trust this document one time only"** (or "Always").
3.  Click on the 3D canvas to activate the model.
...
1.  Clone the repository:
    ```bash
    git clone https://github.com/AhmetBerkeKaya/inventor-3dpdf-pipeline.git
    ```
